    ...
    return (
      <button
        className={cn(
          ...
          {
            'bg-gradient-to-r from-primary-500 to-purple-600 text-white shadow hover:shadow-lg hover:scale-105 active:scale-95':
              variant === 'default',
            'bg-destructive text-destructive-foreground hover:bg-destructive/90':
              variant === 'destructive',
            'border border-gray-300 bg-white hover:bg-gray-50 hover:shadow':
              variant === 'outline',
